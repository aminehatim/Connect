  ...
  ui(new Ui::plotBox)
{
  ...
  ui->customPlot->setTitle("New Plot");
...
void plotBox::axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
...
void plotBox::legendDoubleClick(QCPLegend *legend, QCPAbstractLegendItem *item)
{
...
void plotBox::removeSelectedGraph()
{
...
void plotBox::removeAllGraphs()
{
  ui->customPlot->clearGraphs();
  ui->customPlot->replot();
}

void plotBox::contextMenuRequest(QPoint pos)
{
...
void plotBox::graphClicked(QCPAbstractPlottable *plottable)
{
